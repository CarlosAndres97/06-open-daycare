  ...
  return (
    <div className="flex items-center justify-between gap-4 mb-6">
      ...
      <button
        type="button"
        onClick={onAddClick}
        className="flex items-center justify-center gap-2 py-3 px-4 rounded-[14px] bg-gradient-to-b from-coral-500 to-coral-600 text-white font-extrabold text-[14.5px] shadow-[0_8px_18px_-8px_rgba(238,129,100,0.75)] cursor-pointer"
      >
